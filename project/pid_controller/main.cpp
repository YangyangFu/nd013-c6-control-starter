...
int main ()
{
  ...
  **/
    PID pid_steer = PID();
    pid_steer.Init(0.02,0.001,0.6,1.2,-1.2);
...
//         // Update the delta time with the previous command
          ...
          **/
          ...
          double yaw_error = yaw_desired - yaw;
          double position_error = y_points[closest_point_idx] - y_position;

          error_steer = yaw_error + position_error;
